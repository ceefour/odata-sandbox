...
In JBoss AS 7.1.1, use the configuration in @jboss/standalone-no-jaxrs.xml@

However, it still doesn't work with:

bc. java.lang.UnsupportedOperationException: JBAS011859: Naming context is read-only
